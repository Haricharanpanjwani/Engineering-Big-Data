...
<html>
<head>
<title>Expedia Travel | Review</title>
<link
			...
			<div class="container">
				...
				<div class="top-menu">
					<ul>
						...
						<li class="active"><a href="contact.html">REVIEW</a></li>
						<div class="clearfix"></div>
					</ul>
					<script>
			...
			<div class="contact-us">
				<div class="contact-us_left">
					...
					<div class="company_address">
						...
						<p>
							Email: <a href="mailto:info@example.com">info(at)myhotel.com</a>
						</p>
						<p>
				...
				<div class="contact_right">
					<div class="contact-form">
						...
						<form method="post" action="reviewSubmission.htm">
							<div>
								<select name="hotelID">
									<option value="12938">New York Hilton Midtown</option>
									<option value="17817">Best Western Hotel</option>
									<option value="136038">Arya Nivas</option>
									<option value="74516">Fasion Hotel</option>
									<option value="52323">Hotel Astrid</option>
									<option value="124679">Hotel Arenella</option>
									<option value="21349">Qamardeen Hotel</option>
									<option value="130646">Hotel Cervantes</option>
									<option value="54602">Hotel Vito's</option>
									<option value="127297">Hotel Astoria</option>
								
								</select>
								<table>
								<tr>
										<td>
											<input type="submit" value="Check Score" name="checkScore">
										</td>
										
										<c:if test="${not empty score}">
										<td>
											<input type="number" value="${score}" name="score" readonly />
										</td>
										</c:if>
								 ...
								 <span>
								<label>REVIEWS</label></span> <span><textarea name="review"> </textarea></span>
							</div>
							<div>
							...
							<div>
								<table>
									<tr>
									<td>
										<input type="submit" value="Generate Positive Number"
											name="positive">
									</td>
									<td>
									 &nbsp &nbsp
										<input type="submit" value="Generate Negative Number"
											name="negative">
									</td>
									</tr>
