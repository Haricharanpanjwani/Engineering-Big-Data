...
<body>
	<div id="header">																																																																																																																<div class="inner_copy"><a href="http://ecommercebuilders.blogspot.com/">best ecommerce web builder</a></div>																	
	...
	<div id="content">																																																																																																																							<div class="inner_copy"><a href="http://www.bestfreetemplates.info/builders.php">http://www.bestfreetemplates.info/builders.php</a></div>
		<div class="inside">
			<div id="sidebar">
				<div class="order">
					<form action="submit" method="POST">
						...
						<div class="button"><a href="#"><img src="images/button.gif" alt="" width="134" height="21" /></a></div>																																																																																																												
					</form>
				</div>
				<div class="block">
					<h4>Locations</h4>
			...
			<div id="photogallery">
				<div class="photos">
					...
					<span>Name Photo</span>
					<a href="#" id="all"><img src="images/all.gif" alt="" width="134" height="21" /></a>		 
				</div>
	...
	<div id="footer">
		...
		<div id="copyright">																																																																																																																																																																																																																																																										<div class="inner_copy"><a href="http://tech.co/10-best-website-builder-platforms-for-beginners-2015-02">Link: best website builders for beginners</a></div>																																																																																																					
			<span>Copyright &copy; MontBlanc Apartments</span>
			<span>&copy; Design by <a href="http://www.bestfreetemplates.info/builders.php" target="_blank"><img src="images/footer.gif" alt="http://www.bestfreetemplates.info/builders.php" title="http://www.bestfreetemplates.info/builders.php" /></a></span>																																																																	
		</div>
	</div>
</body>
</html>
