...
namespace GenericAlgorithm
{
    public class ANN
    {
        ...
        // Function to set the best weights of the feature
        ...
        // function to get the weights of the feature
        ...
        // function to predict the value of the class based
        // on the observation
        ...
        // softmax technique is to scale the output node values so that they sum to 1.0.
        // Then the output values can be loosely interpreted as probabilities and easily 
        // mapped to one of the encoded classes to predict
        ...
        // function is use to train the model based on the observation, population size,
        // mutation rate, exit error, mutation change and selection pressure of the
        // best value
        public double[] Train(double[][] trainData, int popSize, int maxGeneration, double exitError,
        ...
        // function to compute the accuracy of the train and test model
        ...
        private void Mutate(Individual child, double maxGene, double mutateRate, double mutateChange)
        {
        ...
        // function to place the children back into the population
        ...
        // function to crossover observation and place it in a population
        private Individual[] Reproduce(Individual parent1, Individual parent2, double minGene, double maxGene, 
        ...
        // function to select the two good observation, not compulsory to be best
