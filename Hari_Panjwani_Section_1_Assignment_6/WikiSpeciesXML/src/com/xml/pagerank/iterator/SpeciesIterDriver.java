...
import org.apache.hadoop.mapred.JobConf;
 ...
 public class SpeciesIterDriver { 
	 ...
	 public static void IteratorRunner(String filePath, int count, int speciesCount, String initialRank, String damp) { 
		 ...
		 conf.set("speciesCount", String.valueOf(speciesCount));
		 conf.set("dampeningFactor", damp);
